...
"""
# Temporarily disable quantization imports to fix module loading
try:
    from .language_model.fp8linearqwen2 import FP8LinearQwen2Config, FP8LinearQwen2Model
    from .language_model.qllava_qllama import QLlavaLlamaConfig, QLlavaLlamaModel
except ImportError as e:
    print(f"⚠️ Quantization modules disabled due to import error: {e}")
    # Define dummy classes to prevent import errors
    class FP8LinearQwen2Config: pass
    class FP8LinearQwen2Model: pass
    class QLlavaLlamaConfig: pass
    class QLlavaLlamaModel: pass
