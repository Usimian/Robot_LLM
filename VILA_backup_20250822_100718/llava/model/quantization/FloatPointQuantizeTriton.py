...
try:
    ...
    try:
        ...
        # libdevice not available in this triton version, use fallback
        libdevice = None
...
def floatExMy_quantize_triton(x, e_bit, m_bit, stochastic):
    if not TRITON_AVAILABLE:
        # Fallback to torch implementation when triton is not available
        from .FloatPointQuantizeTorch import floatExMy_quantize_torch
        return floatExMy_quantize_torch(x, e_bit, m_bit, stochastic)
